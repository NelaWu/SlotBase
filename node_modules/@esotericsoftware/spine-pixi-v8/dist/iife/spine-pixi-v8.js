...
var spine = (() => {
  ...
  var AssetManagerBase = class {
    ...
    error(callback, path2, message) {
      ...
      if (callback) callback(path2, message);
    }
    loadAll() {
    ...
    loadTexture(path2, success = () => {
      ...
      this.cache.assetsLoaded[path2] = new Promise((resolve, reject) => {
        ...
        if (isWebWorker) {
          ...
          if (this.downloader.rawDataUris[path2]) path2 = this.downloader.rawDataUris[path2];
          image.src = path2;
        }
      });
    }
  ...
  var Skeleton = class _Skeleton {
    ...
    getBounds(offset, size, temp = new Array(2), clipper2 = null) {
      ...
      for (let i = 0, n = drawOrder.length; i < n; i++) {
        ...
        if (clipper2 != null) clipper2.clipEndWithSlot(slot);
      }
      if (clipper2 != null) clipper2.clipEnd();
  ...
  var spineTextureAtlasLoader = {
    ...
    resolver: {
      test: (value) => (0, import_pixi2.checkExtension)(value, ".atlas"),
      parse: (value) => {
  ...
  var DarkTintBatcher = class _DarkTintBatcher extends import_pixi6.Batcher {
    ...
    packAttributes(element, float32View, uint32View, index, textureId) {
      ...
      const darkColor = import_pixi6.Color.shared.setValue(element.darkColor).premultiply(worldAlpha, true).toPremultiplied(1, false);
  ...
  var maskPool = new Pool(() => new import_pixi8.Graphics());
      ...
      for (let i = 0; i < currentDrawOrder.length; i++) {
        ...
        if (attachment) {
          if (attachment instanceof MeshAttachment || attachment instanceof RegionAttachment) {
            ...
            (0, import_pixi8.fastCopy)(attachment.uvs.buffer, cacheData.uvs.buffer);
...
//# sourceMappingURL=spine-pixi-v8.js.map

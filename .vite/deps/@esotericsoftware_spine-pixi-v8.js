import {
  ...
  Text,
  checkExtension
} from "./chunk-UCDFGG7Z.js";
import "./chunk-MKRKGLOC.js";
import {
  Cache,
  Graphics,
...
import "./chunk-NODOCOY2.js";
import "./chunk-CZPAV3QY.js";
import "./chunk-2LVO7L5H.js";
import "./chunk-5V52WG3O.js";
import {
  Batcher,
  Buffer,
  BufferUsage,
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/require-shim.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Utils.js
var IntSet = class {
  constructor() {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/Attachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/Sequence.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Animation.js
var Animation = class {
...
var _EventTimeline = class _EventTimeline extends Timeline {
...
var _DrawOrderTimeline = class _DrawOrderTimeline extends Timeline {
  constructor(frameCount) {
...
var _PhysicsConstraintResetTimeline = class _PhysicsConstraintResetTimeline extends Timeline {
  /** @param physicsConstraintIndex -1 for all physics constraints in the skeleton. */
...
var _SequenceTimeline = class _SequenceTimeline extends Timeline {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/AnimationState.js
...
__publicField(_AnimationState, "_emptyAnimation", new Animation("<empty>", [], 0));
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/AnimationStateData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/BoundingBoxAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/ClippingAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Texture.js
var Texture2 = class {
  constructor(image) {
...
var FakeTexture = class extends Texture2 {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/TextureAtlas.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/MeshAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/PathAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/PointAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/attachments/RegionAttachment.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/AtlasAttachmentLoader.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/BoneData.js
var BoneData = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Bone.js
var Bone = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/ConstraintData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/AssetManagerBase.js
var AssetManagerBase = class {
  ...
  loadBinary(path2, success = () => {
    ...
    if (this.reuseAssets(path2, success, error))
      return;
    this.cache.assetsLoaded[path2] = new Promise((resolve, reject) => {
      this.downloader.downloadBinary(path2, (data) => {
        ...
        const errorMsg = `Couldn't load binary ${path2}: status ${status}, ${responseText}`;
  ...
  loadJson(path2, success = () => {
    ...
    this.cache.assetsLoaded[path2] = new Promise((resolve, reject) => {
      this.downloader.downloadJson(path2, (data) => {
        ...
        const errorMsg = `Couldn't load JSON ${path2}: status ${status}, ${responseText}`;
        this.error(error, path2, errorMsg);
        reject(errorMsg);
      });
    });
    ...
    this.cache.assetsLoaded[path2] = new Promise((resolve, reject) => {
      ...
      if (isWebWorker) {
        fetch(path2, { mode: "cors" }).then((response) => {
          ...
          const errorMsg = `Couldn't load image: ${path2}`;
    ...
    this.cache.assetsLoaded[path2] = new Promise((resolve, reject) => {
      this.downloader.downloadText(path2, (atlasText) => {
        try {
          ...
          const errorMsg = `Couldn't parse texture atlas ${path2}: ${e.message}`;
          this.error(error, path2, errorMsg);
          reject(errorMsg);
        }
      }, (status, responseText) => {
        const errorMsg = `Couldn't load texture atlas ${path2}: status ${status}, ${responseText}`;
        this.error(error, path2, errorMsg);
        reject(errorMsg);
      });
    });
  }
  loadTextureAtlasButNoTextures(path2, success = () => {
  }, error = () => {
  }, fileAlias) {
    path2 = this.start(path2);
    if (this.reuseAssets(path2, success, error))
  ...
  async loadBinaryAsync(path2) {
    return new Promise((resolve, reject) => {
      this.loadBinary(path2, (_, binary) => resolve(binary), (_, message) => reject(message));
    });
  }
  async loadJsonAsync(path2) {
    return new Promise((resolve, reject) => {
      this.loadJson(path2, (_, object) => resolve(object), (_, message) => reject(message));
    });
  }
  async loadTextureAsync(path2) {
    return new Promise((resolve, reject) => {
      this.loadTexture(path2, (_, texture) => resolve(texture), (_, message) => reject(message));
    });
  }
  async loadTextureAtlasAsync(path2) {
    return new Promise((resolve, reject) => {
      this.loadTextureAtlas(path2, (_, atlas) => resolve(atlas), (_, message) => reject(message));
    });
  }
  async loadTextureAtlasButNoTexturesAsync(path2) {
    return new Promise((resolve, reject) => {
      this.loadTextureAtlasButNoTextures(path2, (_, atlas) => resolve(atlas), (_, message) => reject(message));
    });
  }
  setCache(cache) {
    this.cache = cache;
  ...
  createTextureAtlas(path2, atlasText) {
    ...
    atlas.dispose = () => {
      ...
      for (const page of atlas.pages) {
        (_a = page.texture) == null ? void 0 : _a.dispose();
      }
    };
    return atlas;
  }
  createTexture(path2, image) {
    ...
    texture.dispose = () => {
      if (this.disposeAssetInternal(path2))
        textureDispose();
    };
    return texture;
  }
};
var _AssetCache = class _AssetCache {
  constructor() {
    __publicField(this, "assets", {});
    __publicField(this, "assetsRefCount", {});
    __publicField(this, "assetsLoaded", {});
  }
  static getCache(id) {
...
__publicField(_AssetCache, "AVAILABLE_CACHES", /* @__PURE__ */ new Map());
var AssetCache = _AssetCache;
var Downloader = class {
  constructor() {
    __publicField(this, "callbacks", {});
    __publicField(this, "rawDataUris", {});
  }
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Event.js
var Event = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/EventData.js
var EventData = class {
  constructor(name) {
    __publicField(this, "name");
    __publicField(this, "intValue", 0);
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/IkConstraint.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/IkConstraintData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/PathConstraintData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/PathConstraint.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/PhysicsConstraint.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Slot.js
var Slot = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/TransformConstraint.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Skeleton.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/PhysicsConstraintData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SkeletonData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Skin.js
var SkinEntry = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SlotData.js
var SlotData = class {
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/TransformConstraintData.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SkeletonBinary.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SkeletonBounds.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/Triangulator.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SkeletonClipping.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/SkeletonJson.js
...
// node_modules/.pnpm/@esotericsoftware+spine-core@4.2.96/node_modules/@esotericsoftware/spine-core/dist/polyfills.js
(() => {
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/SpineTexture.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/assets/atlasLoader.js
...
var spineTextureAtlasLoader = {
  ...
  resolver: {
    ...
    parse: (value) => {
      ...
      return {
        resolution: parseFloat(((_b = (_a = Resolver.RETINA_PREFIX) == null ? void 0 : _a.exec(value)) == null ? void 0 : _b[1]) ?? "1"),
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/assets/skeletonLoader.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/darktint/DarkTintBatchGeometry.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/darktint/darkTintBit.js
var darkTintBit = {
  name: "color-bit",
  vertex: {
    header: (
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/darktint/DarkTintShader.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/darktint/DarkTintBatcher.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/BatchableSpineSlot.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/SpinePipe.js
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/Spine.js
      ...
      if (attachment) {
        if (attachment instanceof MeshAttachment || attachment instanceof RegionAttachment) {
          ...
          if (this.alpha === 0 || alpha === 0) {
            ...
            const texture = ((_a = attachment.region) == null ? void 0 : _a.texture.texture) || Texture.EMPTY;
...
// node_modules/.pnpm/@esotericsoftware+spine-pixi-v8@4.2.96_pixi.js@8.14.0/node_modules/@esotericsoftware/spine-pixi-v8/dist/SpineDebugRenderer.js
...
//# sourceMappingURL=@esotericsoftware_spine-pixi-v8.js.map

...
export class SoundManager {
   ...
   */
  public static playBGM(bgmId: 'mg_bgm' | 'fg_bgm' | 'btm_fg_out_bgm' | 'btm_w_win_loop' | 'btm_w_BSM_loop' | 'btm_w_lengendary_loop' | 'btm_w_ultra_loop' | 'btm_w_jp_loop_2', volume: number = 0.5, waitForInteraction: boolean = true): void {
